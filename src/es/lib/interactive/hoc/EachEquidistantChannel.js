...
var EachEquidistantChannel = function (_Component) {
	...
	_createClass(EachEquidistantChannel, [{
		...
		value: function render() {
			...
			var line1Edge = isDefined(startXY) && isDefined(endXY) ? _jsx("g", {}, void 0, this.getEdgeCircle({
				xy: startXY,
			...
			var line2Edge = isDefined(dy) ? _jsx("g", {}, void 0, this.getEdgeCircle({
			...
			return _jsx("g", {}, void 0, React.createElement(ChannelWithArea, _extends({
				...
				onDragComplete: onDragComplete
			})), line1Edge, line2Edge, React.createElement(HoverTextNearMouse, _extends({

	...
	_createClass(EachFibRetracement, [{
		...
		value: function render() {
			...
			return _jsx("g", {}, void 0, lines.map(function (line, j) {
				...
				return _jsx("g", {}, j, React.createElement(StraightLine, _extends({
					...
					fontSize: fontSize,
					fill: fontFill
				}, void 0, text), React.createElement(ClickableCircle, {
					...
					onDragComplete: onDragComplete }), React.createElement(ClickableCircle, {
					...
					onDragComplete: onDragComplete }), React.createElement(HoverTextNearMouse, _extends({

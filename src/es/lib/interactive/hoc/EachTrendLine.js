...
var EachTrendLine = function (_Component) {
	...
	_createClass(EachTrendLine, [{
		...
		value: function render() {
			...
			return _jsx("g", {}, void 0, React.createElement(StraightLine, {
				...
				onDragComplete: this.handleDragComplete }), React.createElement(ClickableCircle, {
				...
				onDragComplete: this.handleDragComplete }), React.createElement(HoverTextNearMouse, _extends({

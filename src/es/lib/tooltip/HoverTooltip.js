...
var HoverTooltip = function (_Component) {
	...
	_createClass(HoverTooltip, [{
		...
		value: function renderSVG(moreProps) {
			...
			return _jsx("g", {}, void 0, _jsx("rect", {
			...
			}, void 0, backgroundShapeSVG(this.props, bgShape), tooltipSVG(this.props, content)));
		}
	}]);
...
function tooltipSVG(_ref3, content) {
	...
	for (var i = 0; i < content.y.length; i++) {
		...
		tspans.push(_jsx("tspan", {
			x: X,
			y: textY,
			fill: y.stroke
		}, "L-" + i, y.label));
		tspans.push(_jsx("tspan", {}, i, ": "));
		tspans.push(_jsx("tspan", {}, "V-" + i, y.value));
	}
	return _jsx("text", {

...
var EachFibRetracement = function (_Component) {
	...
	_createClass(EachFibRetracement, [{
		...
		value: function render() {
			...
			return _jsx("g", {}, void 0, lines.map(function (line, j) {
				...
				return _jsx("g", {}, j, _react2.default.createElement(_StraightLine2.default, _extends({
					...
					fontSize: fontSize,
					fill: fontFill
				}, void 0, text), _react2.default.createElement(_ClickableCircle2.default, {
					...
					onDragComplete: onDragComplete }), _react2.default.createElement(_ClickableCircle2.default, {
					...
					onDragComplete: onDragComplete }), _react2.default.createElement(_HoverTextNearMouse2.default, _extends({

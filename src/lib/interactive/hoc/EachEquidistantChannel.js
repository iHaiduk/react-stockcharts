...
var EachEquidistantChannel = function (_Component) {
	...
	_createClass(EachEquidistantChannel, [{
		...
		value: function render() {
			...
			var line1Edge = (0, _utils.isDefined)(startXY) && (0, _utils.isDefined)(endXY) ? _jsx("g", {}, void 0, this.getEdgeCircle({
				xy: startXY,
			...
			var line2Edge = (0, _utils.isDefined)(dy) ? _jsx("g", {}, void 0, this.getEdgeCircle({
			...
			return _jsx("g", {}, void 0, _react2.default.createElement(_ChannelWithArea2.default, _extends({

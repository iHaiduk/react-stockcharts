...
var StandardDeviationChannel = function (_Component) {
	...
	_createClass(StandardDeviationChannel, [{
		...
		value: function render() {
			...
			var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end) ? _jsx(_EachLinearRegressionChannel2.default, {
				interactive: false,
			...
			return _jsx("g", {}, void 0, channels.map(function (each, idx) {
			...
			}), tempLine, _jsx(_MouseLocationIndicator2.default, {
				enabled: enabled,
				snap: true,
				snapTo: snapTo,

...
var Axis = function (_Component) {
	...
	_createClass(Axis, [{
		...
		value: function render() {
			...
			var zoomCapture = zoomEnabled ? _jsx(_AxisZoomCapture2.default, {
				bg: bg,
				getScale: getScale,
			...
			}, void 0, zoomCapture, _react2.default.createElement(_GenericChartComponent2.default, { ref: this.saveNode,

...
function getCursorStyle(useCrossHairStyleCursor) {
	...
	return _jsx("style", {
		type: "text/css"
	}, void 0, useCrossHairStyleCursor ? style + tooltipStyle : tooltipStyle);
}
  ...
  */
		...
		value: function render() {
			...
			return _jsx("div", {
				...
				className: className,
				onClick: onSelect
			}, void 0, _react2.default.createElement(_CanvasContainer2.default, { ref: this.saveCanvasContainerNode,
				type: type,
				ratio: ratio,
				width: width, height: height, zIndex: zIndex }), _jsx("svg", {
				className: className,
				width: width,
				height: height,
				style: { position: "absolute", zIndex: zIndex + 5 }
			}, void 0, cursor, _jsx("defs", {}, void 0, _jsx("clipPath", {
				id: "chart-area-clip"
			}, void 0, _jsx("rect", {
				x: "0",
				y: "0",
			...
			}, void 0, _react2.default.createElement(_EventCapture2.default, {
